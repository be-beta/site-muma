...
1. Um arquivo `dados.txt` preenchido com as informações textuais.
2. Uma pasta `imagens/` contendo as fotos e GIFs formatados.
...
[ORIENTACAO_VIDEO_PRINCIPAL]
Indique se o vídeo principal é vertical ou horizontal. Se for vertical, ele será exibido em proporção de tela cheia vertical (9:16) centralizado.
...
<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; border-radius: 16px; border: 1px solid rgba(255,255,255,0.08); box-shadow: 0 20px 40px rgba(0,0,0,0.3);">
  <iframe src="https://player.vimeo.com/video/ID_DO_VIDEO?autoplay=1&loop=1&background=1&muted=1" 
